...
```text
Version: v3.2.0-full-i18n-20260619
Build: 20260619-002
```
...
## 13. v3.2 Full i18n form labels

本版將多語言範圍從頁面名稱擴大到主要表單內部：

1. 欄位標籤
2. 常用按鈕
3. 分頁名稱
4. Dashboard KPI 名稱
5. Admin Config Import / Export 主要表單
6. User Management / Master Data / Admin Data Maintenance 主要維護表單

仍保留英文 DB 欄位與 Excel 欄位，確保程式與 Excel 匯入 / 匯出穩定。
